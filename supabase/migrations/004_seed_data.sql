...
INSERT INTO shipping_methods (name, description, price, estimated_days_min, estimated_days_max, "order") VALUES
  ...
  ('نصب و ارسال توسط تیم مشعوف', 'نصب توسط تیم متخصص گروه صنعتی مشعوف', 500000, 7, 14, 3),
...
INSERT INTO faqs (question, answer, "order") VALUES
  ('چگونه می‌توانم سفارش بدهم؟',
   ...
   1),
  ('آیا نصب درب توسط تیم مشعوف انجام می‌شود؟',
   'بله، تیم متخصص گروه صنعتی مشعوف در تمام استان‌های کشور خدمات نصب ارائه می‌دهد. هزینه نصب بسته به منطقه جغرافیایی متفاوت است.',
   2),
  ('ضمانت محصولات گروه صنعتی مشعوف چند سال است؟',
   'تمام محصولات گروه صنعتی مشعوف دارای ضمانت‌نامه رسمی ۱۰ ساله هستند. ضمانت شامل عیوب ساخت، قفل و سیستم‌های امنیتی می‌شود.',
   3),
  ('آیا امکان بازگشت کالا وجود دارد؟',
   ...
   4),
  ('درب‌های گروه مشعوف از چه فولادی ساخته شده‌اند؟',
   'درب‌های گروه صنعتی مشعوف از فولاد گالوانیزه گرم درجه یک ایتالیایی با ضخامت ۱ تا ۳ میلی‌متر ساخته می‌شوند که مقاومت بالایی در برابر خوردگی دارند.',
   5),
  ('روش‌های پرداخت چیست؟',
...
INSERT INTO settings ("key", value, "group", description, is_public) VALUES
  ...
  ('site_address', '"مازندران، شهرستان قائم شهر، بلوار سید نظام‌الدین، جاده قادیکلای بزرگ، روبروی ولیعصر ۳۶"', 'contact', 'آدرس', TRUE),
  ('working_hours', '"شنبه تا چهارشنبه ۸ تا ۱۷، پنجشنبه ۸ تا ۱۳"', 'contact', 'ساعات کاری', TRUE),
  ('social_instagram', '"https://www.instagram.com/mashoufdoor"', 'social', 'اینستاگرام', TRUE),
  ('social_telegram', '"https://t.me/MashufDoor"', 'social', 'تلگرام', TRUE),
