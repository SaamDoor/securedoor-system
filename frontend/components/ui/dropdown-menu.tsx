...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      'shadow-[0_10px_40px_rgba(0,0,0,0.6)] p-1',
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-white/5',
      destructive
        ? 'text-[#E74C3C] focus:text-[#E74C3C]'
        : 'text-[#A0A0A0] focus:text-white',
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      'relative flex cursor-pointer select-none items-center rounded-lg py-2 pr-8 pl-2 text-sm',
      'text-[#A0A0A0] outline-none transition-colors',
      'focus:bg-white/5 focus:text-white',
      'data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      className,
    )}
  ...
  >
    <span className="absolute right-2 flex h-3.5 w-3.5 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <Check className="h-4 w-4 text-[#C8A85D]" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.CheckboxItem>
...
function DropdownMenuLabel({
  ...
  return (
    <div
      className={cn(
        'px-3 py-1.5 text-xs font-semibold text-[#A0A0A0]',
        inset && 'pr-8',
        className,
      )}
      {...props}
