...
const testimonials = [
  {
    ...
    content:
      'پس از ۱۵ سال کار در حوزه ساختمان، سام درب را بهترین انتخاب برای پروژه‌های لوکس می‌دانم. کیفیت ساخت، دقت در نصب و پشتیبانی پس از فروش واقعاً استثنایی است.',
    rating: 5,
  ...
  },
  {
    ...
    content:
      'تنوع طراحی محصولات سام درب به من این امکان را می‌دهد که برای هر سبک دکوراسیونی، بهترین گزینه را پیدا کنم. مشتریانم همیشه از زیبایی و کارایی این درب‌ها راضی بوده‌اند.',
    rating: 5,
  ...
  },
  {
    ...
    content:
      'برای نوسازی ۲۰۰ اتاق هتلمان به درب‌هایی با کیفیت بین‌المللی نیاز داشتیم. سام درب با ارائه راه‌حل سفارشی و اجرای بی‌نقص، انتظارات ما را فراتر رفت.',
    rating: 5,
  ...
  },
  {
    ...
    content:
      'ضمانت ۱۰ ساله سام درب برایم مهم‌ترین عامل انتخاب بود. بعد از ۳ سال، درب‌ها هنوز مثل روز اول عالی هستند و هیچ مشکلی نداشتیم.',
    rating: 5,
        ...
        <div className="flex flex-col lg:flex-row items-start gap-16">
          ...
          <div className="lg:w-96 flex-shrink-0">
            <SectionHeader
              ...
              description="بیش از ۱۵,۰۰۰ مشتری راضی بهترین گواه کیفیت سام درب هستند."
              animate={false}
            />
