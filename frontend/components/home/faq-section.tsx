...
const faqs = [
  ...
  {
    question: 'آیا نصب درب توسط تیم سام انجام می‌شود؟',
    answer:
      'بله، تیم متخصص سام درب در تمام استان‌های کشور خدمات نصب ارائه می‌دهد. هزینه نصب بسته به منطقه جغرافیایی و نوع درب متفاوت است. نصب توسط کارشناسان دارای مجوز و بیمه انجام می‌شود.',
  },
  {
    question: 'ضمانت محصولات سام درب چند سال است؟',
    answer:
      'تمام محصولات سام درب دارای ضمانت‌نامه رسمی ۱۰ ساله هستند. این ضمانت شامل عیوب ساخت، قفل، یراق‌آلات و سیستم‌های امنیتی می‌شود. خدمات پس از فروش در سراسر کشور از طریق شبکه نمایندگی‌ها ارائه می‌شود.',
  },
  {
  ...
  {
    question: 'درب‌های سام از چه متریالی ساخته شده‌اند؟',
    answer:
      'درب‌های سام از فولاد گالوانیزه گرم درجه یک ایتالیایی با ضخامت ۱ تا ۳ میلی‌متر ساخته می‌شوند. پوشش خارجی از ورق‌های رنگ‌پودری الکترواستاتیک با مقاومت بالا در برابر خوردگی و تغییرات آب‌وهوایی استفاده می‌شود.',
  },
  {
