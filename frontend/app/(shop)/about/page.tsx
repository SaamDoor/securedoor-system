...
const values = [
  ...
  { icon: Users, title: 'تیم متخصص', body: 'مهندسان و کارشناسان با بیش از ۲۰ سال تجربه در صنعت درب‌سازی' },
    ...
    <main dir="rtl" className="bg-black min-h-screen">
      ...
      <section className="relative py-24 border-b border-white/8 overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          <p className="text-muted text-lg leading-relaxed max-w-2xl mx-auto">
            با بیش از ۲۰ سال تجربه در تولید درب‌های ضد سرقت و محصولات ساختمانی لوکس،
      ...
      <section className="container py-20 max-w-3xl">
        ...
        <div className="space-y-4 text-muted leading-loose text-sm">
          <p>
            گروه صنعتی مشعوف در دهه ۱۳۸۰ با هدف ارتقای استانداردهای امنیتی ساختمان‌های مسکونی و صنعتی ایران تأسیس شد.
