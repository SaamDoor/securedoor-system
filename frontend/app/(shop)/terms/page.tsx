...
const sections = [
  ...
  },
  {
    ...
    body: 'تمام محصولات گروه صنعتی مشعوف دارای ضمانت‌نامه ۱۰ ساله هستند. ضمانت شامل عیوب تولیدی و مواد اولیه می‌باشد و رویدادهایی مانند آسیب‌های فیزیکی عمدی، نصب غیرمجاز و استفاده نادرست را در بر نمی‌گیرد.',
  },
  {
    title: '۶. مرجوعی',
