...
import { CheckCircle, Globe, Phone, Mail, MapPin, Instagram, Send } from 'lucide-react'
    ...
    <div className="space-y-5 max-w-3xl">
      ...
      <Tabs defaultValue="general">
        ...
        <TabsContent value="social">
          <div className="rounded-2xl bg-[#181818] border border-white/8 p-6 space-y-5">
            <Input label="اینستاگرام" placeholder="https://instagram.com/..." leftIcon={<Instagram className="h-4 w-4" />} />
            <Input label="تلگرام" placeholder="https://t.me/..." leftIcon={<Send className="h-4 w-4" />} />
            <Input label="واتساپ" placeholder="https://wa.me/..." />
            <Input label="لینکدین" placeholder="https://linkedin.com/company/..." />
        ...
        <TabsContent value="shop">
          <div className="rounded-2xl bg-[#181818] border border-white/8 p-6 space-y-5">
            <Input label="حداقل مبلغ سفارش (تومان)" type="number" defaultValue="500000" />
            <Input label="آستانه ارسال رایگان (تومان)" type="number" defaultValue="5000000" />
            <Input label="درصد مالیات بر ارزش افزوده" type="number" defaultValue="9" />

            <div className="flex items-center justify-between py-3 border-b border-white/8">
              <div>
                <div className="font-medium text-white text-sm">تأیید خودکار نظرات</div>
                <div className="text-xs text-[#A0A0A0]">نظرات کاربران بدون بررسی منتشر می‌شوند</div>
              </div>
        ...
        <TabsContent value="system">
          <div className="rounded-2xl bg-[#181818] border border-white/8 p-6 space-y-5">
            <div className="flex items-center justify-between py-3 border-b border-white/8">
              <div>
                <div className="font-medium text-white text-sm">حالت تعمیرات</div>
                <div className="text-xs text-[#A0A0A0]">سایت برای کاربران عادی غیرقابل دسترس می‌شود</div>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between py-3 border-b border-white/8">
              <div>
                <div className="font-medium text-white text-sm">امکان ثبت‌نام</div>
                <div className="text-xs text-[#A0A0A0]">کاربران جدید می‌توانند ثبت‌نام کنند</div>
              </div>
            ...
            {maintenanceMode && (
              <div className="p-4 rounded-xl bg-[#D49A2A]/10 border border-[#D49A2A]/20 text-sm text-[#F0B429]">
                ⚠️ حالت تعمیرات فعال است. کاربران عادی نمی‌توانند به سایت دسترسی داشته باشند.
              </div>
            )}
          </div>
        </TabsContent>
